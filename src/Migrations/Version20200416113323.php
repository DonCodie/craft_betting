 ...
 */
final class Version20200416113323 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE prono (id INT AUTO_INCREMENT NOT NULL, country_and_league_id INT NOT NULL, home_team_id INT NOT NULL, visitor_team_id INT NOT NULL, result_id INT NOT NULL, website_id INT NOT NULL, website_url_id INT NOT NULL, sport_id INT NOT NULL, date DATE NOT NULL, time TIME NOT NULL, odd VARCHAR(255) NOT NULL, analysis LONGTEXT DEFAULT NULL, INDEX IDX_9B3EC938F873C084 (country_and_league_id), INDEX IDX_9B3EC9389C4C13F6 (home_team_id), INDEX IDX_9B3EC938EB7F4866 (visitor_team_id), INDEX IDX_9B3EC9387A7B643 (result_id), INDEX IDX_9B3EC93818F45C82 (website_id), INDEX IDX_9B3EC938134A3ECC (website_url_id), INDEX IDX_9B3EC938AC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
